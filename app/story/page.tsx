    ...
    <div className="flex flex-col w-full pb-32">
      ...
      <section className="relative w-full overflow-hidden bg-[#0d1510] flex items-center justify-center" style={{ minHeight: "380px" }}>
        ...
        <div className="relative z-10 flex flex-col items-center text-center gap-3 px-6 py-28">
          <span className="text-[10px] font-bold uppercase tracking-[0.35em] text-[#b07e3a]">The Naturalist Origin</span>
          ...
          <p className="text-sm text-white/40 max-w-sm leading-relaxed mt-1">
            Built on the belief that pure is powerful — and that skin deserves honesty.
          </p>
        </div>
      </section>
      ...
      <section className="w-full bg-white dark:bg-[#0a0d0b] py-24 px-6 sm:px-8 border-b border-border/30 transition-colors duration-300">
        <div className="mx-auto max-w-3xl text-center flex flex-col gap-6">
          <p className="font-serif text-2xl sm:text-3xl md:text-4xl font-bold text-[#2d4c38] dark:text-emerald-400 leading-[1.3] tracking-tight">
            "We started because we couldn't find a single skincare brand that told us the whole truth."
          </p>
          <div className="flex items-center justify-center gap-3 mt-2">
            <span className="h-px w-8 bg-border" />
            <span className="font-serif italic text-sm text-muted-foreground">— Founders, Naturalist</span>
            <span className="h-px w-8 bg-border" />
          </div>
          <p className="text-sm text-muted-foreground leading-relaxed max-w-2xl mx-auto mt-4">
            Every bottle on the market had a story — an aspirational pastoral image, a celebrity endorsement, a word like "natural" printed next to an ingredient list that read like a chemistry exam. We decided to build something different: a brand where the ingredient list is the whole point, and every botanical has a traceable origin.
          </p>
        </div>
      </section>
      ...
      <section className="w-full bg-white dark:bg-[#0f1411] py-24 px-6 sm:px-8 border-b border-border/30 transition-colors duration-300">
        <div className="mx-auto max-w-3xl">
          <div className="text-center mb-16">
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#b07e3a]">How We Got Here</span>
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-foreground mt-3 tracking-tight">Five Years, One Standard</h2>
          </div>
      ...
      <section className="w-full bg-white dark:bg-[#0a0d0b] py-24 px-6 sm:px-8 border-b border-border/30 transition-colors duration-300">
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-16">
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#b07e3a]">What Drives Us</span>
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-foreground mt-3 tracking-tight">Our Founding Principles</h2>
          </div>
      ...
      {/* CTA */}
      <section className="w-full bg-[#111a14] py-20 px-6 sm:px-8">
        <div className="mx-auto max-w-2xl text-center flex flex-col items-center gap-6">
          <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#b07e3a]">Ready to Begin?</span>
          <h2 className="font-serif text-3xl sm:text-4xl font-bold text-white leading-snug">
            Experience the Ritual.
          </h2>
          <p className="text-sm text-white/40 leading-relaxed max-w-sm">
            Every product is an extension of this story. Small batch. Third-party tested. Botanically honest.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 mt-2">
            <Link href="/shop" className="flex h-12 items-center justify-center gap-2 rounded-full bg-[#2d4c38] hover:bg-[#3a6349] px-8 text-xs font-bold uppercase tracking-wider text-white transition-all shadow-md">
              Shop All Rituals <ArrowRight className="h-4 w-4" />
            </Link>
            <Link href="/sustainability" className="flex h-12 items-center justify-center rounded-full border border-white/20 hover:border-white/40 px-8 text-xs font-bold uppercase tracking-wider text-white/70 hover:text-white transition-all">
