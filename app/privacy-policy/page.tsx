  ...
  return [
    {
      ...
      body: `Naturalist ('we', 'us', or 'our') is committed to protecting your personal information. This Privacy Policy explains what data we collect when you use our website (${host}), how we use it, who we share it with, and the choices you have. By using our site, you agree to the terms described here.`,
    },
    {
    ...
    {
      heading: "11. Contact",
      body: `For any questions or requests relating to this Privacy Policy, please contact our team at ${CONTACT_EMAIL} or via the contact form on our website.`,
    },
  ];
}
