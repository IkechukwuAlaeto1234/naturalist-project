...
function getDefaultSections(host: string) {
  return [
    {
      heading: "1. Acceptance of Terms",
      body: `By accessing or using the Naturalist website (${host}) or placing an order, you agree to be bound by these Terms of Service. If you do not agree, please do not use our site. We reserve the right to update these terms at any time; continued use constitutes acceptance of any changes.`,
    },
    {
      heading: "2. Eligibility",
      body: `You must be at least 18 years of age to place an order or create an account on ${host}. By using this site, you represent and warrant that you meet this age requirement.`,
    },
    {
    ...
    },
    {
      ...
      body: `Once an order is placed, you have a 2-hour window to modify or cancel it. After that window, fulfilment may have commenced. Contact us immediately at ${CONTACT_EMAIL} if you need to make changes. We reserve the right to cancel any order at our discretion, in which case a full refund will be issued.`,
    },
    {
      heading: "6. Shipping",
    ...
    },
    {
      ...
      body: `All content on ${host} — including text, images, logos, product designs, and code — is the property of Naturalist or its licensors and is protected by copyright and trademark law. You may not reproduce, distribute, or create derivative works without prior written permission.`,
    },
    {
    ...
    {
      heading: "14. Contact",
      body: `Questions about these Terms? Reach us at ${CONTACT_EMAIL} or via our contact form.`,
    },
  ];
}
...
export default function TermsPage() {
  ...
  const host = typeof window !== "undefined" ? window.location.host : (process.env.NEXT_PUBLIC_APP_URL ? new URL(process.env.NEXT_PUBLIC_APP_URL).host : "naturalistbotanicals.com");
  ...
  const handleDownloadPDF = async () => {
    ...
    await generateLegalPDF({
      ...
      effectiveDate: e,
      sections: content?.metadata?.sections || getDefaultSections(host),
  ...
  const sectionsList = content?.metadata?.sections || getDefaultSections(host);
