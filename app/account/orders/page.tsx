...
export default function OrderRegistryPage() {
  ...
  useEffect(() => {
    setMounted(true);
    document.title = "Order History | Naturalist";
  }, []);
        ...
        <div className="bg-white dark:bg-[#0c100e] border border-border/40 dark:border-[#1a241e]/50 rounded-[32px] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.02)] space-y-6">
          ...
          {orders.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 text-center border border-dashed border-[#e2dacd] dark:border-[#232c26] rounded-3xl bg-muted/5">
              ...
              <a href="/shop" className="mt-8 flex h-11 items-center justify-center gap-2 rounded-full bg-[#2d4c38] px-8 text-xs font-bold uppercase tracking-wider text-white hover:bg-[#1a2d21] transition-all shadow-[0_2px_12px_rgba(45,76,56,0.3)] select-none cursor-pointer">
