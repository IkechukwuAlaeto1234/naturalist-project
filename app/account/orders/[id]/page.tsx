      ...
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 h-9 px-5 rounded-full border border-[#e2dacd] dark:border-white/10 text-xs font-bold uppercase tracking-wider text-muted-foreground hover:text-foreground hover:border-foreground/30 transition-all self-start sm:self-auto"
          >
        ...
        {/* ── Order tracking ── */}
        {!isCancelled ? (
          <div className="p-6 rounded-2xl border border-border/40 dark:border-[#232c26] bg-white dark:bg-[#0f1411]">
            <p className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground mb-5">
              Order Tracking
            </p>
            <div className="relative flex items-start gap-0">
              ...
              {STEPS.map((step, i) => {
                ...
                return (
                  <div key={step.key} className="relative flex-1 flex flex-col items-center gap-2" style={{ zIndex: 1 }}>
