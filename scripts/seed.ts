...
const blogPostsData = [
    ...
    sections: [
      {
        ...
        body: "Most routines fail because they are too ambitious. A cleanser, a treatment, and a moisturizer are enough for most people. The rest should be added only when the skin is already stable.",
      },
      {
        heading: "Texture matters",
        body: "If a routine feels heavy or confusing, people stop using it. Keep your products airy, layer them in a simple order, and make sure each step feels like a small ritual rather than a chore.",
        image: "https://images.unsplash.com/photo-1556228720-195a672e8a03?auto=format&fit=crop&w=1400&q=80",
        imageAlt: "Calm botanical skincare flat lay",
      },
      {
        heading: "Commit for 30 days",
        body: "A month is enough time to see whether the routine is helping. Track changes in clarity, hydration, and texture before changing products again.",
      },
    ],
    comments: [
      { name: "Ada", message: "This is the most realistic routine advice I have read in a while.", createdAt: new Date() },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        body: "Bakuchiol supports a smoother-looking complexion and pairs well with calmer routines. It is a good fit for people who want more consistency and less drama.",
      },
      {
        heading: "How to use it",
        body: "Apply it at night after cleansing and before moisturizer. Keep the rest of the routine simple so the ingredient can do its work without competing with too many actives.",
        image: "https://images.unsplash.com/photo-1571781926291-c477ebfd024b?auto=format&fit=crop&w=1400&q=80",
        imageAlt: "Minimal skincare bottle against warm light",
      },
    ],
    comments: [],
  },
  {
    ...
    sections: [
      {
        heading: "Do not overcomplicate the wash step",
        body: "When the cleanser is too strong, every other product starts fighting the skin. A gentle cleanser sets up the rest of the ritual for success.",
      },
      {
        heading: "The right cleanser feels calm",
        body: "A good cleanser leaves the skin balanced and ready, not squeaky or tight. That is the difference between a quick wash and a proper ritual.",
        image: "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&w=1400&q=80",
        imageAlt: "Soft skincare bottle with leaves",
      },
    ],
    comments: [
      { name: "Bayo", message: "This one made me rethink every cleanser I have used before.", createdAt: new Date() },
    ],
  },
];
...
seed();import mongoose from "mongoose";
import bcrypt from "bcryptjs";
import dotenv from "dotenv";
import path from "path";
